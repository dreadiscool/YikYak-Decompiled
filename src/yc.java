  ...
  extends Animation
{
  ...
  private static final WeakHashMap<View, yc> b;
  ...
  public static yc a(View paramView)
  {
    yc localyc = (yc)b.get(paramView);
    if ((localyc == null) || (localyc != paramView.getAnimation()))
    {
      localyc = new yc(paramView);
      b.put(paramView, localyc);
    }
    return localyc;
  }
  ...
  private void a(Matrix paramMatrix, View paramView)
  {
    ...
    label233:
    for (float f4 = this.h;; f4 = f2 / 2.0F)
    {
      float f5 = this.i;
      float f6 = this.j;
      float f7 = this.k;
