...
class NotificationCompatJellybean
{
        ...
        try
        {
          ...
          if (localBundle1 != null)
          {
            ...
            if (localSparseArray != null)
            {
              ...
              NotificationCompatBase.Action localAction2 = readAction(paramFactory, paramFactory1, sActionIconField.getInt(localObject3), (CharSequence)sActionTitleField.get(localObject3), (PendingIntent)sActionIntentField.get(localObject3), localBundle2);
  ...
  public static NotificationCompatBase.Action[] getActionsFromParcelableArrayList(ArrayList<Parcelable> paramArrayList, NotificationCompatBase.Action.Factory paramFactory, RemoteInputCompatBase.RemoteInput.Factory paramFactory1)
  {
    ...
    for (Object localObject = null;; localObject = arrayOfAction)
    {
      return localObject;
