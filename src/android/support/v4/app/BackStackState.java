  ...
  public BackStackRecord instantiate(FragmentManagerImpl paramFragmentManagerImpl)
  {
    ...
    for (int j = 0; j < this.mOps.length; j = i5)
    {
      ...
      if (FragmentManagerImpl.DEBUG) {
        new StringBuilder().append("Instantiate ").append(localBackStackRecord).append(" op #").append(i).append(" base fragment #").append(this.mOps[k]).toString();
      }
      int[] arrayOfInt2 = this.mOps;
      int m = k + 1;
      int n = arrayOfInt2[k];
      ...
      for (localOp.fragment = ((Fragment)paramFragmentManagerImpl.mActive.get(n));; localOp.fragment = null)
      {
        ...
        {
          if (FragmentManagerImpl.DEBUG) {
            new StringBuilder().append("Instantiate ").append(localBackStackRecord).append(" set remove fragment #").append(this.mOps[i5]).toString();
          }
