...
public class AccessibilityNodeInfoCompat
{
  ...
  {
    AccessibilityNodeInfoCompat.CollectionInfoCompat localCollectionInfoCompat = null;
    Object localObject = IMPL.getCollectionInfo(this.mInfo);
    if (localObject == null) {}
    for (;;)
    {
      return localCollectionInfoCompat;
      localCollectionInfoCompat = new AccessibilityNodeInfoCompat.CollectionInfoCompat(localObject, null);
    }
  }
  
  public AccessibilityNodeInfoCompat.CollectionItemInfoCompat getCollectionItemInfo()
  {
    AccessibilityNodeInfoCompat.CollectionItemInfoCompat localCollectionItemInfoCompat = null;
    Object localObject = IMPL.getCollectionItemInfo(this.mInfo);
    if (localObject == null) {}
    for (;;)
    {
      return localCollectionItemInfoCompat;
      localCollectionItemInfoCompat = new AccessibilityNodeInfoCompat.CollectionItemInfoCompat(localObject, null);
    }
  }
  ...
  {
    AccessibilityNodeInfoCompat.RangeInfoCompat localRangeInfoCompat = null;
    Object localObject = IMPL.getRangeInfo(this.mInfo);
    if (localObject == null) {}
    for (;;)
    {
      return localRangeInfoCompat;
      localRangeInfoCompat = new AccessibilityNodeInfoCompat.RangeInfoCompat(localObject, null);
    }
  }
