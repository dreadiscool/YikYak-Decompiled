...
public class ActionBarPolicy
{
  ...
  public boolean hasEmbeddedTabs()
  {
    ...
    for (boolean bool = this.mContext.getResources().getBoolean(R.bool.abc_action_bar_embed_tabs);; bool = this.mContext.getResources().getBoolean(R.bool.abc_action_bar_embed_tabs_pre_jb)) {
      return bool;
    }
  }
