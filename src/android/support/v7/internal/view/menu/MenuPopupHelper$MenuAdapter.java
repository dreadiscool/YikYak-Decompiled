  ...
  extends BaseAdapter
{
  ...
  public int getCount()
  {
    ...
    label43:
    for (int i = localArrayList.size();; i = -1 + localArrayList.size())
    {
      return i;
  ...
  {
    if (paramView == null) {}
    for (View localView = MenuPopupHelper.access$200(this.this$0).inflate(MenuPopupHelper.ITEM_LAYOUT, paramViewGroup, false);; localView = paramView)
    {
