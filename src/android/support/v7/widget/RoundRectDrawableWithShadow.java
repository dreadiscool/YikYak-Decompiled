  ...
  extends Drawable
{
  ...
  private void buildShadowCorners()
  {
    ...
    for (;;)
    {
      ...
      localPaint1.setShader(new RadialGradient(0.0F, 0.0F, f2, arrayOfInt1, arrayOfFloat1, Shader.TileMode.CLAMP));
      ...
      localPaint2.setShader(new LinearGradient(0.0F, f3, 0.0F, f4, arrayOfInt2, arrayOfFloat2, Shader.TileMode.CLAMP));
      this.mEdgeShadowPaint.setAntiAlias(false);
      return;
  ...
  {
    if (paramBoolean) {}
    for (float f = (float)(1.5F * paramFloat1 + (1.0D - COS_45) * paramFloat2);; f = 1.5F * paramFloat1) {
      return f;
    }
  }
