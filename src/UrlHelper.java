...
public class Im
{
    ...
    // public static String a(String, String, TreeMap<String, String>, YakkerLocation)
    public static String calculateRequestUrl(String paramString1, String paramString2, TreeMap<String, String> paramTreeMap, YakkerLocation paramYakkerLocation)
    {
        int i = 1;
        ...
        String firstFolderString = (String)localList.get(localList.size() - 1);
        ...
        for (int j = 0;; j = i)
        {
            ...
            break;
            label380:
            String str3 = a("/" + firstFolderString + "/" + paramString2 + unixTimestampString, YikYak.userId.getBytes());
    ...
    // public static String a(String, TreeMap<String, String>, YakkerLocation)
    public static String calculateRequestUrl(String paramString, TreeMap<String, String> paramTreeMap, YakkerLocation paramYakkerLocation)
    {
        String str;
        if (a == null)
        {
    ...
    /* Error */
    // public static String a(String, byte[])
    public static String calculateRequestHash(String paramString, byte[] paramArrayOfByte)
    {
        // Best effort pls no h8, decompiler didn't decompile
        try {
            SecretKeySpec localSecretKeySpec = new SecretKeySpec(paramArrayOfByte, "HmacSHA1");
            Mac localMac = Mac.getInstance("HmacSHA1");
            localMac.init(localSecretKeySpec);
            String str2 = Base64.encodeToString(localMac.doFinal(paramString.getBytes());
            String str3 = str2.trim();
            String str1 = str3;
        } catch (Exception ex) {
            ex.printStackTrace(); // Yes I'm lazy, no h8 pls
        }
        return str1;
