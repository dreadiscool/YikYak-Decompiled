  ...
  implements Serializable
{
  ...
  void authorize(AuthorizationClient.AuthorizationRequest paramAuthorizationRequest)
  {
    ...
    for (;;)
    {
      ...
      if ((!paramAuthorizationRequest.needsNewTokenValidation()) || (checkInternetPermission()))
      {
  ...
  boolean checkInternetPermission()
  {
    ...
    for (;;)
    {
      ...
      {
        this.checkedInternetPermission = bool;
      }
    }
  }
  ...
  RequestBatch createReauthValidationBatch(AuthorizationClient.Result paramResult)
  {
    ...
    localRequest3.setCallback(new AuthorizationClient.4(this, localArrayList2, localArrayList3));
    Request[] arrayOfRequest = new Request[3];
    arrayOfRequest[0] = localRequest1;
    arrayOfRequest[1] = localRequest2;
    arrayOfRequest[2] = localRequest3;
    RequestBatch localRequestBatch = new RequestBatch(arrayOfRequest);
    localRequestBatch.setBatchApplicationId(this.pendingRequest.getApplicationId());
    localRequestBatch.addCallback(new AuthorizationClient.5(this, localArrayList1, paramResult, localArrayList2, localArrayList3));
  ...
  AuthorizationClient.StartActivityDelegate getStartActivityDelegate()
  {
    ...
    if (this.startActivityDelegate != null) {
      localObject = this.startActivityDelegate;
    }
    for (;;)
    {
      return localObject;
      if (this.pendingRequest != null) {
        localObject = new AuthorizationClient.2(this);
      } else {
        localObject = null;
      }
    }
  ...
  boolean onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    for (boolean bool = this.currentHandler.onActivityResult(paramInt1, paramInt2, paramIntent);; bool = false) {
      return bool;
    }
  }
  ...
  boolean tryCurrentHandler()
  {
    ...
    {
      return bool;
      bool = this.currentHandler.tryAuthorize(this.pendingRequest);
      if (bool) {
