  ...
  extends Button
{
  ...
  private void fetchUserInfo()
  {
    if (this.fetchUserInfo)
    {
      ...
      {
        Request localRequest = Request.newMeRequest(localSession, new LoginButton.2(this, localSession));
  ...
  private boolean initializeActiveSessionWithCachedToken(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      if (localSession != null) {
        bool = localSession.isOpened();
      } else if ((Utility.getMetadataApplicationId(paramContext) != null) && (Session.openActiveSessionFromCache(paramContext) != null)) {
        bool = true;
      }
    }
  }
