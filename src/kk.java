...
public abstract class kk
  ...
  implements kj
{
  public static kj a(IBinder paramIBinder)
  {
    Object localObject;
    ...
    for (;;)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof kj))) {
        localObject = (kj)localIInterface;
      } else {
        localObject = new kl(paramIBinder);
      }
    }
  }
  ...
  public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      a(lh.a(paramParcel1.readStrongBinder()));
