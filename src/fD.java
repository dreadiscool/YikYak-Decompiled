  ...
  extends SQLiteOpenHelper
{
  ...
  fD(fC paramfC, Context paramContext, String paramString)
  {
  ...
  private boolean a(String paramString, SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    //   94: invokestatic 113	fA:d	(Ljava/lang/String;)V
    //   97: aload 6
    //   99: ifnull +10 -> 109
    //   102: aload 6
  ...
  {
    if ((this.b) && (3600000L + this.c > fC.a(this.a).a())) {
      throw new SQLiteException("Database creation failed");
    }
    Object localObject = null;
    this.b = true;
    this.c = fC.a(this.a).a();
    try
    {
    ...
    catch (SQLiteException localSQLiteException)
    {
      for (;;)
      {
        fC.c(this.a).getDatabasePath(fC.b(this.a)).delete();
      }
    }
    if (localObject == null) {
  ...
  {
    gp.a(paramSQLiteDatabase.getPath());
  }
  ...
  public void onOpen(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          paramSQLiteDatabase.execSQL(fC.e());
          return;
        }
      }
      finally
